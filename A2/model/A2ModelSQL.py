...
class A2EnvExtreme:
    ...
    def get_Gb(self):
        ...
        '''
        Gb = np.array([self.baseStations[i].global_computing_resource - (self.baseStations[i].reserved_computing_resource + self.u * self.baseStations[i].vehicle_density) for i in range(self.b)])
        return Gb
